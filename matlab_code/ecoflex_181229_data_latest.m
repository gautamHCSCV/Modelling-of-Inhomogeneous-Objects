...
P = 'C:\Users\DELL\Downloads\Inhomogeneous data\Ecoflex_hemisphere2_inhomogeneous_Sinusoidal_181229_position_2400';
...
for j = 1:1
    ...
    for i = 1:12
        ...
        t = f(i,1:l);
        m = 'C:\Users\DELL\Downloads\Inhomogeneous data\Ecoflex_hemisphere2_inhomogeneous_Sinusoidal_181229_position_2400\';
        y = append(m,t);
        Spill1 = importdata(y);
        x = Spill1(:,4);
        y = Spill1(:,16);
        ...
        for mm = 1:length(in)
            f1 = [f1;y(in(mm),:)];
            poss_percep = [poss_percep;x(in(mm),:)];
    ...
    t1 = num2str(j);
    t2 = '_ch_percep_force_ecoflex_181229_data.csv';
    t3 = '_ch_percep_pos_ecoflex_181229_data.csv';
    ...
    t4 = '_ch_force_ecoflex_181229_data.csv';
    t5 = '_ch_pos_ecoflex_181229_data.csv';
    ...
    t7 = '_only_pos_eco_181229.csv';
    d5 = append(t1,t7);

    csvwrite(d5, poss);


    t8 = '_only_percep_pos_eco_181229.csv';
    d6 = append(t1,t8);

    csvwrite(d6, poss_percep);
