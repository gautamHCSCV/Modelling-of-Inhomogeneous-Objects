...
for j = 1:200
    ...
    for i = 1:15
        ...
        v_est2 = foaw_diff(disp,0.001,200,0.0000674);
        vel = v_est2';
    ...
    displacement = horzcat(xcor,ycor,dis1,velocity);
    ...
    t2 = '_per_force_ecoflex_181221_data.csv';
    
    t3 = '_per_x_y_pos_vel_ecoflex_181221_data.csv';
...
%de = horzcat(xcor, ycor);

%csvwrite('x_y_value_for_all_points.csv', de);
