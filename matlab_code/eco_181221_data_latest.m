...
for j = 1:1
    ...
    t1 = num2str(j);
    t2 = '_ch_percep_force_ecoflex_181221_data.csv';
    t3 = '_ch_percep_pos_ecoflex_181221_data.csv';
    ...
    t4 = '_ch_force_ecoflex_181221_data.csv';
    t5 = '_ch_pos_ecoflex_181221_data.csv';
    ...
    t7 = '_only_pos_eco_181221.csv';
    d5 = append(t1,t7);

    csvwrite(d5, poss);


    t8 = '_only_percep_pos_eco_181221.csv';
    d6 = append(t1,t8);
