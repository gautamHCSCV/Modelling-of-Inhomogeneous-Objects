    ...
    for i = 1:1
        ...
        for p = 1:5
            ...
            for alpha = 0:0.01:0.1
               ...
               yd = fderiv( x,alpha, 180,h );
               yd_c = reshape(yd,[length(yd),1]);
        
               f_pred = beta_o*yd_c;
        
               err = sqrt(mean((y - f_pred).^2));
...
gh = horzcat(signal,al, be, er);

csvwrite('final_points_1_to_10.csv', gh);
