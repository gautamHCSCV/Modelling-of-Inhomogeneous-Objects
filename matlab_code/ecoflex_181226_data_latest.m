...
P = 'C:\Users\DELL\Downloads\Inhomogeneous data\Ecoflex_hemisphere_inhomogeneous_Sinusoidal_181226_position_2400';
...
for j = 1:1
    ...
    for i = 1:12
        ...
        t = f(i,1:l);
        m = 'C:\Users\DELL\Downloads\Inhomogeneous data\Ecoflex_hemisphere_inhomogeneous_Sinusoidal_181226_position_2400\';
        y = append(m,t);
        Spill1 = importdata(y);
        x = Spill1(:,4);
        y = Spill1(:,16);
    ...
    t1 = num2str(j);
    t2 = '_ch_percep_force_ecoflex_181226_data.csv';
    t3 = '_ch_percep_pos_ecoflex_181226_data.csv';
    ...
    t4 = '_ch_force_ecoflex_181226_data.csv';
    t5 = '_ch_pos_ecoflex_181226_data.csv';
    ...
    t7 = '_only_pos_eco_181226.csv';
    d5 = append(t1,t7);

    csvwrite(d5, poss);


    t8 = '_only_percep_pos_eco_181226.csv';
    d6 = append(t1,t8);
