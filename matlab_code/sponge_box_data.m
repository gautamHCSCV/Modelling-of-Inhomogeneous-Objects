...
P = 'C:\Users\DELL\Downloads\Inhomogeneous data\Sponge_Box_inhomogeneous_Sinusoidal_190429_position_2400';
...
for j = 1:1
    ...
    for i = 1:8
        ...
        t = f(i,1:l);
        m = 'C:\Users\DELL\Downloads\Inhomogeneous data\Sponge_Box_inhomogeneous_Sinusoidal_190429_position_2400\';
        y = append(m,t);
        Spill1 = importdata(y);
        x = Spill1(:,4);
        y = Spill1(:,16);
    ...
    t1 = num2str(j);
    t2 = '_percep_force_sponge_box_data.csv';
    t3 = '_percep_pos_sponge_box_data.csv';
    ...
    t4 = '_force_sponge_box_data.csv';
    t5 = '_pos_sponge_box_data.csv';
