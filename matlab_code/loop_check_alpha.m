...
for j = 1:1
    ...
    %t1 = num2str(j);
    %t2 = '_foaw_force_ecoflex_181221_data.csv';
    %t3 = '_foaw_pos_ecoflex_181221_data.csv';
    %t4 = '_foaw_velocity_ecoflex_181221_data.csv';
    ...
    for p = 1:10
        ...
        for alpha = 0:0.01:0.1
           ...
           yd = fderiv( dis1,alpha, 180,h );
           yd_c = reshape(yd,[length(yd),1]);
    
           f_pred = beta_o*yd_c;
    
           err = sqrt(mean((f1 - f_pred).^2));
